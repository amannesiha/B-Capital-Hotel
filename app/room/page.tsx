    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-5xl font-bold mb-4 text-balance">Our Rooms & Suites</h1>
          <p className="text-xl text-pretty max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-4xl font-bold mb-4 text-balance">Ready to Book Your Stay?</h2>
          <p className="text-xl mb-8 text-pretty">
            Experience the comfort and luxury of B Capital Hotel. Book your room today and enjoy our exceptional
            service.
          </p>
