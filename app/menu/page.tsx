...
const menuSections = [
  {
    ...
    items: [
      {
        name: "Grilled Prawns",
        description: "Fresh prawns grilled to perfection with herbs and spices",
        price: "$18",
        featured: true,
      },
      {
        name: "Chicken Wings",
        description: "Crispy wings served with our signature sauce",
        price: "$14",
      },
      {
    ...
    items: [
      {
        ...
        description: "Our famous chicken dish served with rice and vegetables",
        price: "$28",
        featured: true,
      },
      {
      ...
      },
      {
        ...
        description: "Premium cut beef cooked to your preference",
        price: "$38",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Coffee & Tea",
        description: "Premium coffee or selection of teas",
        price: "$4",
      },
      {
        name: "Soft Drinks",
        description: "Coca-Cola, Sprite, or local beverages",
        price: "$3",
      },
    ],
  },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-balance">Our Menu</h1>
